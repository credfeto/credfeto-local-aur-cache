...
internal static partial class LocalAurRpcLoggingExtensions
{
    ...
    public static partial void SaveMetadataFailed(this ILogger<LocalAurRpc> logger, string filename, string message, Exception exception);

    [LoggerMessage(LogLevel.Error, EventId = 2, Message = "Failed to read saved metadata: {filename}: {message}")]
    public static partial void FailedToReadSavedMetadata(this ILogger<LocalAurRpc> logger, string filename, string message, Exception exception);
    ...
    public static partial void NoMetadata(this ILogger<LocalAurRpc> logger, int packageId, string packageName, string metadataFileName);

    [LoggerMessage(LogLevel.Information, EventId = 7, Message = "Search Found: {package} using {keyword} by {by}")]
    public static partial void OfflineSearchFound(this ILogger<LocalAurRpc> logger, string package, string keyword, string by);
}