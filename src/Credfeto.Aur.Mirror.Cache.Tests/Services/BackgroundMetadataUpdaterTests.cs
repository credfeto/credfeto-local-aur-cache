...
public sealed class BackgroundMetadataUpdaterTests : TestBase
{
    ...
    {
        _ = this._localAurMetadata.Get("example-package").Returns(this._examplePackage);
    ...
    {
        _ = this._localAurMetadata.Get("invalid-package").Returns(this._packageDoesNotExist);
